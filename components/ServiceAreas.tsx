...
export default function ServiceAreas() {
  return (
    <section id="service-areas" className="py-24 lg:py-32 section-bg-alt dark:bg-zinc-950 relative overflow-hidden" onMouseEnter={() => trackEvent('service_area_viewed')}>
