...
const testimonials = [
  {
    ...
    rating: 5,
    text: 'Pipe burst under my kitchen sink at 11pm on a Sunday. Called Apex and had a tech at my door by 12:30am. He fixed it in 45 minutes, cleaned up every drop of water, and charged exactly what he quoted. I was floored.',
    initials: 'SM',
    color: 'bg-apple-blue',
  },
  {
    ...
    rating: 5,
    text: 'Woke up to no hot water on a Monday morning. Apex had a tech out by 10am. He showed me the issue, explained the two options, gave me the exact prices, and had my new heater installed and running by noon. Outstanding.',
    initials: 'DR',
  ...
  },
  {
    ...
    rating: 5,
    text: 'Three different plumbers told me I might need to tear up my floor to fix the drain. Apex used a camera and found the actual blockage in 10 minutes, cleared it in 20, and didn\'t touch my floor. $180 instead of $3,000.',
    initials: 'JK',
  ...
  },
  {
    ...
    rating: 5,
    text: 'Sewer line issue that 2 companies wanted $8,000 to fix. Apex did a camera inspection, diagnosed the actual problem, and repaired it trenchlessly for $2,400. They saved my yard and saved me $5,600.',
    initials: 'AP',
    color: 'bg-status-green',
  },
  {
    ...
    rating: 5,
    text: 'Needed a gas line run for a new range. Apex pulled the permit, scheduled the utility inspection, and did the whole job in one day. Clean work, all up to code. The inspector actually complimented the installation.',
    initials: 'MW',
    color: 'bg-status-amber',
  },
]
