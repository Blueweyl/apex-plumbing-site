...
const steps = [
  {
    ...
    description: "Call (555) 247-8629 anytime or fill out the form below. Tell us what's wrong — we'll ask a few quick questions to send the right tech with the right parts.",
    time: 'Takes 2 minutes',
    color: 'from-apple-blue to-blue-500',
    bgLight: 'bg-apple-blue-light',
    textColor: 'text-apple-blue',
  },
  {
    number: '02',
    title: 'Tech arrives fast',
    description: "A background-checked, licensed plumber is at your door — average 90 minutes. You'll get a text when they're dispatched and another when they're 10 minutes out.",
  ...
  },
  {
    ...
    description: "Your tech diagnoses the issue and gives you the full price upfront — before touching anything. No \"we already started, so…\" pressure. You say yes or no.",
    time: 'No surprises',
    color: 'from-blue-400 to-status-green',
  ...
  },
  {
    ...
    description: "Work gets done. Your tech cleans up completely before leaving. You get a digital receipt and a 12-month guarantee. If it breaks again, we're back for free.",
    time: '12-month guarantee',
    color: 'from-status-green to-green-400',
    bgLight: 'bg-status-green-bg',
    textColor: 'text-status-green',
  },
]
...
export default function HowItWorks() {
  return (
    <section className="py-24 lg:py-32 bg-apple-surface relative overflow-hidden">
      {/* Background shapes */}
      <div className="absolute bottom-0 left-0 w-[600px] h-[300px] bg-apple-blue/4 rounded-full blur-3xl pointer-events-none -translate-x-1/3 translate-y-1/2" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-10 left-[calc(12.5%+28px)] right-[calc(12.5%+28px)] h-[2px] overflow-hidden rounded-full">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-apple-blue via-blue-400 to-status-green opacity-70 animate-[bar-fill_2s_ease_0.5s_both]" />
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, i) => (
              ...
              >
                ...
                <div className="absolute -top-4 -left-2 text-[96px] font-black text-apple-dark/[0.04] leading-none select-none pointer-events-none group-hover:text-apple-blue/10 transition-colors duration-500">
                  {step.number}
                </div>
